(function () {
    ...
    var stageDom = document.getElementById((window._mrmcp || {})['script_id'] || "Mugeda_61b95e04ee5b5b6f7945130c")

    _mrmcp = (typeof _mrmcp == 'undefined') ? {} : _mrmcp;
_mrmcp['campaign_id'] = 'none';
_mrmcp['owner_id'] = '5a05c9f892b5796e8e43bd81';
_mrmcp['creative_id'] = '61b95e04ee5b5b6f7945130c';
...
_mrmcp['type'] = 'smart';
_mrmcp['title'] = '测测你的2022人生关键词';
_mrmcp['build_number'] = parseInt('801');
_mrmcp['publish_time'] = 'Tue Jan 04 2022 16:23:53 GMT+0800 (CST)';
...
var version = _mrmcp['version'] = _mrmcp['version'] != null ? _mrmcp['version'] : '0.8.1';
...
Mugeda.loadProcessHandle['default2'] = function (opt) {
    opt = opt || {};
...
Mugeda.loadProcessHandle['default2'].prototype.init = function (stageDom, pos) {
...
Mugeda.loadProcessHandle['default2'].prototype.update = function (num, all, opt) {
...
Mugeda.loadProcessHandle['default2'].prototype.remove = function () {
    //return;
    var self = this;
    setTimeout(function () {
        self.isOver = true;
...
if(!window['_mrmcp']['loader']){
    var loadProcessHandleInstance = Mugeda['loadProcessHandleInstance'] = new Mugeda['loadProcessHandle']['default2']({
        'loadInfo': {"textLoading":0,"messageText":"","messageSize":12,"messageColor":"#FFF","progressColor":"#F36523","progressBackground":"#FFF","backgroundColor":"#000","progressPosition":"100","logoWidth":128,"style":"default2"},
        'thisAni': {
            'dom': null,
            'width': 320
        },
...
window['Mugeda']['Loader'] = function (dom, hasScript, _mrmcp) {
    ...
    if(!Mugeda['css3PlayerLoaded']) {
        ...
        loadRes(1, jsPath + that.crid + ".js?publishTime=1641284633850", [], undefined, function(callback){
            var chk = function(){
...
Mugeda.Loader.prototype.start = function () {
    if (2 == Mugeda.css3PlayerLoaded) {
        ...
        Mugeda['startAnimation']("id_" + this.crid, false ? "actions_" + this.crid + ".js?publishTime=1641284633850" : "", a, this.resDir, this.name, null, this._mrmcp)
    }
    else {
    ...
    if(_mrmcp['render_mode']!='embedded'&&_mrmcp['render_mode']!='inline'){
        ...
        document.body.style.backgroundColor='rgba(28, 28, 28, 1)';
